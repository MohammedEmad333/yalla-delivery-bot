...
const APP_DOWNLOAD_MESSAGE =
  ...
  `📱 Android: ${OFFICIAL_ANDROID_SHORT_URL}\n` +
  `🌐 تطبيق الويب: ${APP_WEB_URL}\n` +
  `🏠 الموقع الرئيسي: ${APP_HOME_URL}`;
...
function buildAISystemPrompt() {
  return [
    ...
    'اكتب بالعربية الطبيعية وبنفس أسلوب ولهجة العميل قدر الإمكان، وبنبرة ودودة ومختصرة وواضحة وغير رسمية أكثر من اللازم.',
